...
namespace Rc6_app
{
    public class RC6
    {
        ...
        private static void GenerateKey(int keyLong, byte[] keyCheck)
        {
            ...
            switch (keyLong)
            {
                case 128:  // длина ключа 16 байт
                    c = 4; // кол-во слов в ключе
                    break;
                case 192:// длина ключа 24 байта
                    c = 6; // кол-во слов в ключе
                    break;
                case 256: // длина ключа 32 байта
